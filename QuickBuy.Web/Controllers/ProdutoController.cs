...
namespace QuickBuy.Web.Controllers
{
    ...
    public class ProdutoController : Controller
    {
        ...
        private static string GerarNovoNomeArquivo(string nomeArquivo, string extensao)
        {
            ...
            novoNomeArquivo = $"{novoNomeArquivo}_{DateTime.Now.Year}{DateTime.Now.Month}{DateTime.Now.Day}{DateTime.Now.Minute}{DateTime.Now.Second}{DateTime.Now.Millisecond}.{extensao}";
